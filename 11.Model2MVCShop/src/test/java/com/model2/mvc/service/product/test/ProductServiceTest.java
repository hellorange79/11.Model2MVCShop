...
public class ProductServiceTest {
	...
	public void testAddProduct() throws Exception {
		...
		//product.setProdNo();시퀀스 사용		
		product.setProdName("지갑");
		product.setProdDetail("샤넬");
		product.setManuDate("20171125");
		product.setPrice(999999);
		product.setFileName("지갑.jpg");
	...
	//@Test
	 public void testUpdateProduct() throws Exception{
		...
		product.setProdName("아이폰88");
		product.setPrice(450000);
		product.setProdDetail("최신형");
		product.setManuDate("20171225");
